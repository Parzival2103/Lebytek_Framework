    ...
    <div class="col-12 col-xl-10">
        <div class="ct-form-card card border-0 shadow-sm ct-card">
            <div class="card-header bg-transparent border-bottom px-4 py-3">
                ...
                <p class="text-muted small mb-0 mt-1">Asigna permisos según el catálogo actual del sistema.</p>
            </div>
            <div class="card-body p-4">
                <form method="POST" action="/admin/administracion/roles" id="rolForm">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="descripcion" name="descripcion" class="form-control" rows="2"
                                      placeholder="Descripción del rol..."><?= ViewHelper::old('descripcion') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-4 pt-3 border-top">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg me-2" aria-hidden="true"></i>Crear rol
                        </button>
...
document.querySelectorAll('[data-select-grupo]').forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        const visible = [...checks].filter(c => c.closest('.permiso-linea').offsetParent !== null);
