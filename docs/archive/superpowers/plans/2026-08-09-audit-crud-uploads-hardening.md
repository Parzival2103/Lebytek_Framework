...
|------:|------|-------------------|-----------|
| 1 | `2026-08-07-crud-p01-authz-multi-canal.md` | completo | PR #95 @ `64a6877` |
| 2 | `2026-08-07-crud-p02-states-form-options.md` | completo | PR #100 @ `60477dc` |
| 3 | este plan (C6) | completo | PR #111 @ `e9f1607`, tag `v1.2.8` |
...
| Siguiente tarea ejecutable | ninguna — plan cerrado |
| Prerrequisitos | Cumplidos (p01, p02, REL-C1 `v1.2.7`, tag `v1.2.8` publicado) |
| Bloqueos | Portal lock bump ≥ `v1.2.8` no verificado (M6) — ops humano |
| Estado | **completo** en main |
| Evidencia | PR #111 merge `e9f16075b0856b847629ef7e92921bc850b2ac5d`; `UploadValidator.php` allowlist+denylist; `FileUploadService.php` jail `realpath`; `CrudConfigValidator::uploadsBlockErrors`; `tests/Crud/Upload/CrudConfigValidatorUploadsTest.php`; semver `1.2.8` en commit #111; tag Git `v1.2.8` publicado |
