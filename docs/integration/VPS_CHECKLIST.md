...
- [ ] Migraciones marketing recientes: Stripe columns, plantillas seed, membresías, landing experiments, leads API/churn
...
- [ ] Mantener `PAYMENTS_SUBSCRIPTION_CHECKOUT=false` hasta cerrar issue #21 (activación subscription / invoice.paid)
