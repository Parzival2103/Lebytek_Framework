...
|------:|------|-------------------|-----------|
| 1 | `2026-08-07-crud-p01-authz-multi-canal.md` | completo en main | PR #95 @ `64a6877` |
| 2 | `2026-08-07-crud-p02-states-form-options.md` | completo en main (archivado) | PR #100 @ `60477dc`; semver tip `1.2.7` |
