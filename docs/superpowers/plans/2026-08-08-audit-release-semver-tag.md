...
| Framework `origin/main` referencia | `5bf0863f45116b3e574a085c0dca2bed46ed983a` |
| Tareas completadas / totales | 0 / 6 |
| Siguiente tarea ejecutable | Task 1 (`ReleaseTagPublishedTest`) |
| Prerrequisitos | Trío semver @ `1.2.7` verificado; tag `v1.2.7` ausente |
