...
<div class="ct-page">
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-stretch align-items-sm-center gap-3 mb-4 ct-actions">
    <a href="/admin/administracion/usuarios/crear" class="btn btn-primary d-inline-flex align-items-center justify-content-center gap-2">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" id="usuariosTable">
                <thead class="table-light">
                    <tr>
                        <th class="px-4 sortable" data-col="0">Nombre</th>
