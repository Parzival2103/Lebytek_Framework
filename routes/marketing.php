...
use App\Presentation\Controllers\Publico\MembresiaPagoController;
...
$router->get('/membresia/reintentar-pago', [MembresiaPagoController::class, 'reintentarPago']);
$router->get('/membresia/reactivar', [MembresiaPagoController::class, 'reactivar']);
$router->get('/membresia/pago/exito', [MembresiaPagoController::class, 'pagoExito']);
$router->get('/membresia/pago/cancelado', [MembresiaPagoController::class, 'pagoCancelado']);
$router->get('/membresia/reactivar/exito', [MembresiaPagoController::class, 'pagoExito']);
$router->get('/membresia/reactivar/cancelado', [MembresiaPagoController::class, 'pagoCancelado']);
